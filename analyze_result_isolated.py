...
def analyzeCSV(x, y, t, directory, filename):
	...
	if(not noAnims):
		...
		graphing.save_animation(f"{exportAnimName}_x_vs_t_points.gif", [], [], colors1, "rainbow", [t], [x], [t[-1], 1920], len(x), 400, False, "Horizontal Position vs Time", "Time (ms)", "Horizontal Position (px)")
		debugPrint(f"Saving {exportAnimName}_x_vs_t_line.gif...")
		graphing.save_animation(f"{exportAnimName}_x_vs_t_line.gif", [t], [x], colors1, "rainbow", [], [], [t[-1], 1920], len(x), 400, False, "Horizontal Position vs Time", "Time (ms)", "Horizontal Position (px)")
	...
	if(not noAnims):
		...
		graphing.save_animation(f"{exportAnimName}_y_vs_t_points.gif", [], [], colors1, "rainbow", [t], [yFlipped], [t[-1], 1080], len(x), 400, False, "Vertical Position vs Time", "Time (ms)", "Vertical Position (px)")
		debugPrint(f"Saving {exportAnimName}_y_vs_t_line.gif...")
		graphing.save_animation(f"{exportAnimName}_y_vs_t_line.gif", [t], [yFlipped], colors1, "rainbow", [], [], [t[-1], 1080], len(x), 400, False, "Vertical Position vs Time", "Time (ms)", "Vertical Position (px)")
	...
	if(not noAnims):
		...
		graphing.save_animation(f"{exportAnimName}_y_vs_x_points.gif", [], [], colors1, "rainbow", [x], [yFlipped], [1920, 1080], len(x), 400, False, "Vertical vs Horizontal Position", "Horizontal Position (px)", "Vertical Position (px)")
		debugPrint(f"Saving {exportAnimName}_y_vs_x_line.gif...")
		graphing.save_animation(f"{exportAnimName}_y_vs_x_line.gif", [x], [yFlipped], colors1, "rainbow", [], [], [1920, 1080], len(x), 400, False, "Vertical vs Horizontal Position", "Horizontal Position (px)", "Vertical Position (px)")
